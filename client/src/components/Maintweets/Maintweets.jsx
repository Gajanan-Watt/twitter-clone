    ...
    <div>
      ...
      <form className="border-b-2 pb-6">
        ...
        <div className="flex justify-start mb-3 mt-2">
          ...
          />
          {open && (
            <div className="absolute w-full h-full top-0 left-0 bg-transparent flex items-center justify-center z-10">
              <div className="w-[600px] h-[300px] bg-slate-200 rounded-lg p-8 flex flex-col gap-4 relative">
                <button
